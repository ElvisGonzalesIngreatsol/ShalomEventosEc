...
">
<a
  href="https://v0.app/chat/api/open/built-with-v0/b_giUVIA6OY1H"
  target="_blank"
  rel="noopener"
  style="
    color: inherit;
...
<button
  onclick="document.getElementById('v0-built-with-button-42b3fcd3-e759-4d12-89cc-81c008b408ad').style.display='none'"
